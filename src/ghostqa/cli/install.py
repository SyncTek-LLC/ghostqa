"""ghostqa install — Install browser dependencies (Playwright).
...
def install(
    ...
    """Install Playwright browsers required for GhostQA browser testing.
    ...
    if not ci:
        ...
        console.print(
            Panel(
                ...
                title="[bold]GhostQA Browser Setup[/bold]",
                border_style="blue",
            )
        )
        console.print()
    ...
    if not ci:
        console.print(
            Panel(
                ...
                "You're ready to run GhostQA:\n"
                "  [bold]ghostqa run --product demo[/bold]",
